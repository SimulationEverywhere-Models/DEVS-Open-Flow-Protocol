...
struct inp_ack : public cadmium::in_port<int>{};

/***** Define output ports for coupled model *****/
struct outp_ackNum : public cadmium::out_port<int>{};
struct outp_sentPacket : public cadmium::out_port<int>{};
struct outp_data : public cadmium::out_port<Packet>{};
...
int main(){
    ...
    dynamic::modeling::Ports oports_TOP = {typeid(outp_sentPacket), typeid(outp_data), typeid(outp_ackNum)};
    dynamic::modeling::Models submodels_TOP = {input_reader_con, input_reader_ack, sender1};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<Sender_defs::packetNumSentOut,outp_sentPacket>("sender1"),
        dynamic::translate::make_EOC<Sender_defs::packetSentOut,outp_data>("sender1"),
    ...
    dynamic::modeling::ICs ics_TOP = {
        ...
        dynamic::translate::make_IC<iestream_input_defs<int>::out,Sender_defs::ackIn>("input_reader_ack","sender1")
    };
